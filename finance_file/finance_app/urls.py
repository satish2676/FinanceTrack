...
urlpatterns = [
    ...
    path('member_details/', views.member_details, name='member_details'),  # No mobile parameter here
    path('member_details/<int:mobile>/', views.member_details, name='member_details_by_mobile'),  # With mobile parameter
